...
function CreatePost () {
    ...
    //invokes the getDate function and initialize the data with default values  
    useEffect(() => {
        getDate();
    }, []);

    //navigate to the different routes
    const navigate = useNavigate();

    //set up the initial state variable data. the initial state object is empty
    ...
    //create state variable date and set up the initial empty string
