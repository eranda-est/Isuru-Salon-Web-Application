      ...
      <br /><br />
        ...
        <Modal show={show} onHide={handleClose} >
            <Modal.Header closeButton>
                <Modal.Title style={{color:"#000000"}}>Update Transactions</Modal.Title>
            </Modal.Header>
        ...
        {data ? (
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <br /><br />
                <center>
                    <h1 style={{color:"#ffffff", fontWeight:"bolder", fontSize:"50px"}}>Income & Expense</h1>
                </center>
            ...
            <div className="container">   
                ...
                <thead>
                  ...
                  <th scope="col" style={{color:"#ffffff"}}>Amount(LKR)</th>
                  <th scope="col" style={{color:"#ffffff"}}>Type</th>
                  <th scope="col" style={{color:"#ffffff"}}>Category</th>
                  <th scope="col" style={{color:"#ffffff"}}>Date</th>
                  <th scope="col" style={{color:"#ffffff"}}>Description</th>
                  <th scope="col" style={{color:"#ffffff"}}>Reference</th>
                  <th></th>
                  <th scope="col" style={{color:"#ffffff"}}>Action</th>
                    ...
                    return (
                        ...
                        <td style={{color:"#ffffff"}}>{post.amount}</td>
                        <td style={{color:"#ffffff"}}>{post.type}</td>
                        <td style={{color:"#ffffff"}}>{post.category}</td>
                        <td style={{color:"#ffffff"}}>{post.date}</td>
                        <td style={{color:"#ffffff"}}>{post.description}</td>
                        <td style={{color:"#ffffff"}}>{post.reference}</td>
                        <td >
                        
                        <button  style={{width: "80%",
                                    marginLeft:'10px', background: "#E8B592", border:"#E8B592"
                        }} onClick={() => updatePost(post)}>UPDATE</button>   </td>

                        <td>
                        <button style={{width: "90%", marginLeft:'-20%', marginTop:"", background: "#", border:"#E8B592"}} onClick={() => deletePost(post._id)}>DELETE</button>
                        </td>
